...
#%% Section 1 - ATP simulation of the clamp-on ground meter method in SBC.
...
#%% Section 2 - Analysis of the proposed solution and CGM methods - Machine learning
...
#%% Section 3 - ATP simulation and analysis of High Frequency Methods in SBC
