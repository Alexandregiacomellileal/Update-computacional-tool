...
10. **Prediction:**
    - Use the trained model to predict the resistances $\textbf{R}_f$ for the $n$ turbines based on clamp-on method readings during wind farm periodic inspections Z~med. H<sub>2</sub>O
